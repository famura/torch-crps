...
def crps_analytical_normal(
    ...
    See Also:
        T. Gneiting et al., "Calibrated Probabilistic Forecasting Using Ensemble Model Output Statistics and Minimum
        CRPS Estimation", 2004,
        https://journals.ametsoc.org/view/journals/mwre/133/5/mwr2904.1.pdf
